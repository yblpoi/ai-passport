...
- [avatar-pixelation.md](engineering/avatar-pixelation.md): how a photo becomes a 40x40 avatar — the kernel pipeline, the five tunable knobs, measured behaviour, and the contracts around the wire format.
